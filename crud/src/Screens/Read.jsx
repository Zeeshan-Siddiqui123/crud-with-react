    ...
    return (
        <div>
            <div className='flex items-center flex-col'>
                ...
                <button className='bg-green-700 block-inline p-2 text-white w-[100px] rounded-lg'><a href="">Add</a></button>
                <table className="w-3/4 table-auto text-lg  ml-auto mr-auto mt-10">
                    ...
                    <tbody className=' p-2'>
                        <tr className='mt-4'>
                            ...
                            <td className="text-center">
                                <a className='px-5 py-2 w-[100px] border-2 text-yellow-600 rounded-lg '>Update</a>
